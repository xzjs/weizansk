				...
				<tbody>
					<?php  if(is_array($menus)) { foreach($menus as $k => $v) { ?>
						...
						<tr>
							...
							<td>
								<div class=""><input type="text" class="form-control" style="width:120px;display:inline-block" name="title[]" value="<?php  echo $v['title'];?>">&nbsp;<i class="fa fa-chevron-down" data-id="<?php  echo $v['id'];?>"> </i></div>
							</td>
						...
						<?php  if(!empty($v['child'])) { ?>
							...
							<tr class="level1 p_<?php  echo $v1['pid'];?>" style="display: none">
							...
							<?php  if(!empty($v1['grandchild'])) { ?>
								...
								<tr class="p_<?php  echo $v2['pid'];?> p_<?php  echo $v['id'];?>" style="display: none">
								...
								<?php  } } ?>
							<?php  } ?>
							<tr class="p_<?php  echo $v1['id'];?> p_<?php  echo $v['id'];?>" style="display: none">
								<td colspan="11">
						...
						<?php  } } ?>
					<?php  } ?>
					<tr class="level1 p_<?php  echo $v['id'];?>" style="display: none">
						<td></td>
