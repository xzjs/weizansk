...
<div class="register">
	...
	<div class="center-block footer" role="footer">
		...
		<div class="text-center">
			...
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://#">域顺集团</a>&nbsp;&nbsp;<a href="http://#">域顺金融</a>&nbsp;&nbsp;<a href="#">联系客服</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>

		</div>

		<div class="text-center">

			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="#"><b>域顺</b></a> v<?php echo IMS_VERSION;?> &copy; 2016 <a href="http://#">www.yushunbox.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
