...
<div class="xiaoyu_container cl">
	...
	<?php  if(is_array($data)) { foreach($data as $da) { ?>
		...
		<div class="col-md-5">
        <a href="<?php  echo url('article/news-show/detail', array('id' => $da['id']));?>" target="_blank"><img src="<?php  if(!$da['thumb']) { ?><?php  echo $_W['siteroot'];?>/web/resource/images/nopic.jpg<?php  } else { ?><?php  echo tomedia($da['thumb']);?><?php  } ?>" alt="<?php  echo $da['title'];?>" class="img-responsive" /></a>
		</div>    
		<div class="col-md-7">
    ...
    <div class="posts margin-bottom-40"> 
	 ...
	 <?php  if(is_array($data)) { foreach($data as $da) { ?>
		<dl class="dl-horizontal">
			<dt><a href="<?php  echo url('article/news-show/detail', array('id' => $da['id']));?>"><img  src="<?php  if(!$da['thumb']) { ?><?php  echo $_W['siteroot'];?>/web/resource/images/nopic-small.jpg<?php  } else { ?><?php  echo tomedia($da['thumb']);?><?php  } ?>"></a></dt>
			<dd>
