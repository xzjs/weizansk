					...
					<div class="item2" data-title=<?php  echo $row['title'];?> data-type=<?php  echo $row['type'];?>>
						...
						<div class="biz-div">
							...
							<div class="biz-info-0">
								...
								<div class="biz-div-1">
									...
									<span>
										...
										<em>作者 : </em><a href="#"><?php  if(!empty($_W['setting']['copyright']['smname'])) { ?><?php  echo $_W['setting']['copyright']['smname'];?><?php  } else { ?>系统<?php  } ?> (<?php  if(!empty($_W['setting']['copyright']['sitehost'])) { ?><?php  echo $_W['setting']['copyright']['sitehost'];?><?php  } else { ?>www.yushunbox.com<?php  } ?>)</a>
							...
							<div class="biz-info-1">
								...
								<a href="#" class="pull-left" style="width:245px">
