...
<ul class="nav nav-tabs">
    <li><a href="{$this->createWebUrl('allfans', array('op' => 'display'))}"></a></li>
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('allfans', array('id' => $item['id'], 'op' => 'post'))?>"><i class="fa fa-list"></i></a>
